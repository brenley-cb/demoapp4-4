"""
Django settings for demoapp4_4 project.
...
WSGI_APPLICATION = 'demoapp4_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp4_4 API",
    "DESCRIPTION": "API documentation for demoapp4_4 App",
    "VERSION": "v1",
}
